let data = [
     ...
     */
    {
        ...
        initializationAlgorithm: 'shellscript', // TODO: add initalizeNode to shared class, and then according to node setting choose specific initalizeNode class to execute.
        label: {
